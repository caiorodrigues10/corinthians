...
function NavBarLink({ className, href, onClick, toId, children, ...rest }) {
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
        href: href,
        className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])("hover:text-gray-400 cursor-pointer", className),
        onClick: (e)=>{
            onClick?.(e);
            e.preventDefault();
...
//# sourceMappingURL=stories-components-NavBar-stories.62dd62e429754e829505.hot-update.js.map