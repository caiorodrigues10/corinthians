...
const Template = args => {
  if (!args.links) return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "Erro: Nenhum link fornecido!");
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(___WEBPACK_IMPORTED_MODULE_1__.NavBar.Root, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(___WEBPACK_IMPORTED_MODULE_1__.NavBar.Logo, {
...
NavBarStories.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "(args: NavBarProps) => {\n  if (!args.links) return <div>Erro: Nenhum link fornecido!</div>;\n  return <NavBar.Root>\n      <NavBar.Logo altText=\"Logo do site\" />\n      <NavBar.Content>\n        {args.links.map(link => <NavBar.Link key={link.toId} toId={link.toId}>\n            {link.text}\n          </NavBar.Link>)}\n      </NavBar.Content>\n    </NavBar.Root>;\n}",
...
//# sourceMappingURL=stories-components-NavBar-stories.0510280abdb43ea04ed9.hot-update.js.map