...
function NavBarLink({ className, href, onClick, toId, children, ...rest }) {
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
        href: href,
        className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__["default"])("hover:text-gray-400 cursor-pointer navbar-link hover:scale-50", className),
        onClick: (e)=>{
            onClick?.(e);
            e.preventDefault();
...
//# sourceMappingURL=stories-components-NavBar-stories.fb818ae17fc03b60bfec.hot-update.js.map